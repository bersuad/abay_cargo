          ...
          <View style={{...styles.inputView, width: '50%',}}>
            <TextInput
              ...
              onChangeText={(text) =>{
                ...
                setVehicleDetails({...vehiclesDetails, insurance_type: text})
                }
              }
            /> 
          </View>
