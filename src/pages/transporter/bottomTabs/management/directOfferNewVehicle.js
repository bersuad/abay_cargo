...
export default function NewVehicle(props) {
  ...
  const [getSelectedTrailer, setGetSelectedTrailer] = useState("");
  const [getSelectedTruckID, setGetSelectedTruckID] = useState("");
  ...
  const setCurrenttrailer = (trailer_id) => {
    ...
    setGetSelectedTrailer(trailer_id_val);
  ...
  const setCurrentPlateNo = (v_id) => {
    ...
    setGetSelectedTruckID(vehicle.vehicle_id);
  ...
  addVehicleOffer = async () => {
    ...
    let online_details = JSON.stringify({
      ...
      api_key: api_key,
      user_id: user_id,
      truck_id: getSelectedTruckID,
      trailer_id: Number(getSelectedTrailer)
            ...
            <View>
                ...
                <View>
                    ...
                    <View
                      ...
                      <View style={{ ...styles.inputView, width: '10%', backgroundColor: '#fff', borderRadius: 0, borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>S.No</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '16%', backgroundColor: '#fff', borderRadius: 0, borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>Ref Num</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '11%', backgroundColor: '#fff', borderRadius: 0, borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>Model</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '22%', backgroundColor: '#fff', borderRadius: 0, borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>Pow. Plate No. & Type</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '22%', backgroundColor: '#fff', borderRadius: 0, borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>Tra. Plate No. & Type</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '16%', backgroundColor: '#fff', borderRadius: 0, height:100}}>
                  ...
                  {addedVehicleList ?
                    ...
                    <View
                      ...
                      <View style={{ ...styles.inputView, width: '22%', backgroundColor: '#fff', borderRadius: 0, marginTop: "-10%", borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>{loads.plate_number} & {loads.vehicle_type}</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '22%', backgroundColor: '#fff', borderRadius: 0, marginTop: "-10%", borderRightColor: '#111', borderRightWidth:1, height:100}}>
                        <Text>{loads.trailer_plate_no} & {loads.trailer_vehicle_type}</Text>
                      </View>
                      <View style={{ ...styles.inputView, width: '16%', backgroundColor: '#fff', borderRadius: 0, marginTop: "-10%", height:100}}>
                        <Text>{loads.driver_name}</Text>
                      </View>
                    </View>
                  )
                  ): ""
      ...
      <SafeAreaView style={styles.container}>
        ...
        <SelectDropdown
          ...
          onSelect={(vehicleList, index) => {
            ...
            setSelectedTruck(vehicleList.vehicle_name_id);
          }}
